...
<a target="_blank" href="https://www.youtube.com/watch?v=Vi67QEuHF3M&t=1m15s">VIDEO</a>:
...
<a href="#Dynastries">Dynastries History</a>, 
<a href="#Elements">Elements 素 sù</a>, 
<a href="#eSIM">eSIM vs VPN</a>,
<a href="#Firewall">Firewall</a>,
<a href="#Flights">Flights</a>,
<a href="#Foods">Foods</a>, 
<a href="#Glossary">Glossary</a>, 
<a href="#History">History</a>, 
<a href="#HSK_exam">HSK_exam</a>, 
<a href="#Idioms">Idioms</a>, 
<a href="#Jade">Jade</a>, 
<a href="#Languages">Languages</a>, 
<a href="#LearningStrategies">LearningStrategies</a>, 
<a href="#Memonics">Memonics</a>, 
<a href="#Movies">Movies</a>, 
<a href="#Norms">Norms</a>, 
<a href="#Payments">Payments</a>,
<a href="#Personal_possessions">Personal possessions</a>,
<a href="#Pinyin">Pinyin Alphabet</a>, 
<a href="#Provinces">Provinces</a>, 
<a href="#Seasons">Seasons</a>, 
<a href="#Smalltalk">Smalltalk</a>, 
<a href="#Street_signs">Street signs</a>, 
...
Secondary students in China take the Gaokao exam to graduate. Subjects Science, Math, Chinese, English are taken on separate days for 90 to 150 minutes each. Different provinces have different versions.

The Chinese language proficiency of non-native speakers (wai guo ren) are evaluated by CLEC, the China-wide Center for Language Education and Cooperation, under the federal Ministry of Education, administers standardized HSK & HSKK exams that are the Chinese equivalent of the TOEFL or IELTS for English. 
...
1. Install apps that work within China's "Great Firewall".
    
    Use <a target="_blank" href="https://www.websitepulse.com/tools/china-firewall-test">websitepulse.com</a> or <a target="_blank" href="https://www.chinafirewalltest.com/?siteurl=facebook.com">chinafirewalltest.com</a> or to see whether a specific websites are blocked to select cities in China <a target="_blank" href="https://www.experte.com/internet-censorship/china">(Russia, Turkey)</a>:
    
    | blocked .com | category | avail. |
    | ------------ | -------- | ------ |
    | gmail.com, proton.me, iCloud.com, outlook.com | web email | tuta.com, live.com, gmx.com, mail.qq.com, mail.163.com |
    ...
    | Uber.com | Ride | Didi.com |
    | Telegram.com | news | WeChat (weixin.qq.com), DingTalk (dingtalk.com) |
    | Twitter/X | news | Sina Weibo (weibo.com), weixin.qq.com |
    Douyin (douyin.com) |
...
1. If ear buds don't give you ear pain, <a target="_blank" href="https://www.amazon.com/Timekettle-W4-Interpreter-Real-Time-Translation/dp/B0GT7HN145">$398</a> <a target="_blank" href="https://www.timekettle.co/products/w4-pro-ai-interpreter-earbuds-2026">Timekettle M4 Pro earbuds</a>. It understands the context of entire sentences in 13 pairs of languages offline. But an internet connection helps with accuracy.
   
   WARNING: Most translation earbuds have a 2-5 second delay and struggle with background noise or overlapping talk among speakers.

   For two-way conversations, keep one earbud and give the other one to another person. The battery (rated "up to 6 hourse") may not last long enough.

   NOT RECOMMENDED: For <strong>real-time speech-to-text</strong> with translation during meetings, there are E-ink tablets: $499 8.5" AINote Air2, <a target="_blank" href="https://www.amazon.com/stores/iFLYTEK/page/E9F2D2A8-3FCB-4091-A012-DCFBEA22F09E">$649 10" iFLYTEK AINote</a> with AI Write.
...
1. Learn <a href="#Pinyin">Pinyin</a> to pronounce Chinese names for <a href="#Personal_possessions">Personal possessions</a>. When needed, refer to the <a href="#Personal_possessions">list below</a>. Learn to pronounce <a href="#Foods">foods</a> or point to my list. Home items. 
   ...
   Children in mainland China, before drawing stokes of traditional calligraphy glyphs (in a very specific sequence), first learn the <a href="#Pinyin">Pinyin alphabet</a>.
...
1. Identify <a href="#Movies">media (movies)</a> that show Chinese glyphs and <a href="#Pinyin">Pinyin</a> plus the English. Reality shows and vlog bloggers have less stilted sound.
   ...
   NOTE: To further language unification, the government in China requires subtitles on films.

1. For more natural, ultimately faster learning, avoid translating individual words to focus understanding whole sentences. Learn individual words in a cluster so you better grasp context.

1. <strong>Repeat actors' dialog out loud</strong> to get your mouth used to the pace and pronounciation. You'll also discover the <a href="#Mores">norms, mores</a> and <a href="#Idioms">idioms</a> of Chinese culture. <a href="#CityNames">CityNames</a>
...
1. Record yourself mimicking the subtle tones of what performers say, then playback to compare.

1. If you are from the US, practice converting metric to US imperial units of measure: 
   * between kilometers and miles, 
   * Multiply km/h by 0.6 to get mph. The standard highway speed limit is 120 km/h means 74.5 mph. On bullet trains, 300 km/h = 180 mph. 5 miles is exactly equal to 8 kilometers.
   * Divide kilojoules by 4.184 to get calories.

1. So you can better appreciate visiting museums, learn the <a href="#Dynasties">Dynasties</a> so you can better understand the artwork and how historical stories interconnect. 
...
1. <a target="_blank" href="https://www.youtube.com/watch?v=Wg9fNbRqWck">VIDEO</a>: Know the 10 most common radicals used to form 100 Chinese characters. They are <a href="#Radicals">Radicals</a> with some resemblance to the object.

   There are <a target="_blank" href="https://singandlearnchinese.com/chinese-radicals/#1stroke">214 radicals</a> that make up most single Chinese characters in use today. Some radicals come in more than one variant.

   <a target="_blank" href="https://singandlearnchinese.com/song-index/">Songs</a> (listed by difficulty)
...
On Coursera Peking University course "Chinese" by Yu Bin:
...
1. Hanyu Maggie (grammar deep dives)
1. Chinese Zero to Hero (HSK 6-9 prep)

1. Use <a target="_blank" href="https://www.hellochinese.cc">HelloChinese</a> (Levels 1-3) for game-based basics learning.
1. Use Anki or Hack Chinese every single day to memorize the specific HSK vocabulary list.
1. Use $120/year (7-day trial) Du Chinese to practice reading words in context as stories with audio.

1. Use macOS app <a target="_blank" href="https://www.hskonline.com/">SuperTest</a> (formerly HSK Online) provides a mock exam to practice the timing and exact format of the test. It's repetitive, though. $15/mo or $20/mo MAX for AI essay correction.
...
<a target="_blank" https://www.youtube.com/watch?v=UOvmVE9JBIc&pp=0gcJCcQLAYcqIYzv">10:41</a> New HSK 1 Course Workbook : Lesson 1 : 你好 (Hello) : Chinese Listening & Practice by Beginner Mandarin
...
To get a Chinese local services on the local China network
to ensure glitch-free local food delivery with Chinese SMS,
get a local phone number. Go to a <strong>China Unicom</strong> store with your passport. Plans may vary by store/city.
VPN may be blocked.

https://www.youtube.com/watch?v=2nSD4NoykX0&pp=ugUEEgJlbg%3D%3D
...
SAR (Special Administrative Regions) have their own:
...
* +86-10-8531-4000 for life-or-death emergencies involving a U.S. citizen (arrest, death, serious illness/injury)
* 5679-4700 US Visa Information Call Center. From US: 703-665-1986.
...
1 USD was worth the highest 8.72 on May 1994, then declining gradually to <a target="_blank" href="macrotrends.net/3570/chinese-yuan-to-usd-exchange-rate">6.78 on Aug 16</a>. So stock up!
...
1. Scan a QR code 二维码 Èr wéi mǎ for mobile payments.
...
PROTIP: Devices in the US have voltage: 120V, 60Hz, so need "Type A" US plugs with two flat parallel pins will physically fit into Chinese plugs with a "stepdown" adapter for China voltage: 220V, 50Hz. 
"Type B" US plugs with a round grounding pin need an adapter that converts Type B (US) to Type I (China).

   References:
   * https://www.youtube.com/watch?v=rk8Lk4YK6cI = "Shopping at a Supermarket in Chinese : Beginner Mandarin Conversation : HSK 1-2 by Mandarin Breeze : 汉语微风
   * https://www.youtube.com/watch?v=kv4LsY_KOfI = All Integrated Chinese in One Video – 8.5 hours – Integrated Chinese Volume 1/ Level 1 Part 1 
...
China has more high-speed trains than the rest of the world, combined.

"Business class" has lie-flat seats with private screens.
McDonalds and other meals can be delivered to those individual pods.
...
<a target="_blank" href="https://res.cloudinary.com/dcajqrroq/image/upload/v1787404828/zn-provinces_vmaw88.webp"><img alt="zn-provinces.webp" src="https://res.cloudinary.com/dcajqrroq/image/upload/v1787404828/zn-provinces_vmaw88.webp" /></a>

China has <a target="_blank" href="https://www.youtube.com/watch?v=cJM0N8al3YU">23 Provinces (省 Shěng)</a>, Municipalities, SARs. MapsofChina.com. <a target="_blank" href="https://commons.wikimedia.org/wiki/File:China_provinces_numbered.svg">SVG map</a> from <a target="_blank" href="en.wikipedia.org/wiki/Provincial-level_divisions_of_China">Wikipedia</a>.

Province	Capital City	Notable For
1. Guangdong	Guangzhou	Manufacturing hub, Cantonese food, Shenzhen (tech)
1. Sichuan	Chengdu	Spicy food (mapo tofu), pandas, amazing landscapes
1. Yunnan	Kunming	Ethnic diversity, mild climate, beautiful mountains
1. Guizhou	Guiyang	Karst landscapes, Miao and Dong minority cultures
1. Hunan	Changsha	Spicy food, birthplace of Mao Zedong
1. Hubei	Wuhan	Yangtze River, Three Gorges Dam
1. Henan	Zhengzhou	Central China, birthplace of Chinese civilization
1. Shandong	Jinan	Confucius's birthplace, big seafood, Qingdao beer
1. Jiangsu	Nanjing	Wealthy, ancient capitals, rice and fish cuisine
1. Zhejiang	Hangzhou	West Lake, e-commerce (Alibaba), tea (Longjing)
1. Fujian	Fuzhou	Fujian cuisine, Xiamen, many Chinese emigrants
1. Jiangxi	Nanchang	Poyang Lake, porcelain (Jingdezhen)
1. Anhui	Hefei	Huangshan (Yellow Mountain), Hui cuisine
1. Hebei	Shijiazhuang	Encircles Beijing, historical sites
1. Shanxi	Taiyuan	Coal, ancient wooden temples
1. Shaanxi	Xi'an	Terracotta Army, ancient Silk Road capital
1. Gansu	Lanzhou	Yellow River, Gobi Desert, Lanzhou noodles
1. Qinghai	Xining	Tibetan Plateau, headwaters of the Yellow River
1. Liaoning	Shenyang	Heavy industry, Korean border
...
* 香港 Xiānggǎng = Hong Kong HKG - Tiger Balm gardens railroad
* 重庆 Chóngqìng = Mountain City

* Chengdu panda base 
* Shaolin <a target="_blank" href="https://www.youtube.com/watch?v=5_dQ-xYcm5k">Kung Fu</a> Monestary in Dengfeng 

* Quanzhou (a massive medieval port city that was the starting point of the Maritime Silk Road)

Health certificate (体检证明) – from a government-approved Chinese hospital.

Private International Insurance: You must have comprehensive medical insurance. A serious illness without insurance could bankrupt you.
Options: Cigna Global, Bupa, Allianz, IMG, GeoBlue. Expect to pay 
3,000 − 3,000−10,000 USD/year depending on age and coverage.
Jiahui, Parkway, United Family
...
* 2026-02-28 International Women’s Day 
* 2026-05-24 International Children’s Day
...
But Japanese, which used only 2,136 characters, made metal movable type using the "Ming Dynasty" font (Minchotai).
Gutenberg began experimenting with printing and movable type in Strasbourg, Germany around 1430.
1454–1455: Guttenberg invention was proven a massive success with the printing of the Gutenberg Bible (also known as the 42-line Bible), which is considered the first major book printed using his movable type system.

In 1959, 3,624 commonly used chinese word list was defined by ZWGW.

Samuel Toddwell at MIT 
Each Chinese character is written using up to 62 strokes in the same order.
but autocomplete
12 fundamental strokes are mapped to IBM Sinotype keyboard, plus 3 alternate numbers keys.

From "The Chinese computer" by <a target="_blank" href="https://www.youtube.com/watch?v=KSEoHLnIXYk">Thomas Mulllany at Stanford</a>
In 1980 mainland China defined GB 2312 Unicode set containing 6,723 double-byte characters.
In 1983, CCDOS created an add-on  board to process double-byte chars. See drama "Our Times".
In 1984, Taiwan defined the Big 5 (Traditional Chinese) Character code table containing 13,060 characters, 
which Hong Kong adapted after HKSCS FA40-FEFE (UDA1) supplemental set.
In 2000, the CJK Unified Ideographs Extension B was defined as ISO/IEC FCD 10646:2000 containing 97,000 characters
so that the same Hansu input character display as different glyph for each country.

Mainland china defined Standard, Traditional, and Variant characters while Taiwan defined Orthodox and Variants.
About 2,500 characters were simplified in mainland China, some based on cursive script characters which existed earlier. That's the case for the word cloud (yun) and love (ai).
...
At home in America, on internet browsers such as Google Chrome, I keep open all the time one of these <strong>pronunciation</strong> websites where I paste words I copy Chinese from other tabs:

1. <a target="_blank" href="https://forvo.com/languages/zh/">Forvo for Mandarin</a>  
   https://forvo.com/search/%E5%88%9D%E4%B8%80/ (初一) 

   Click the blue dot with the triangle to hear the pronounciation.
...
1. Go to Time & language > Language & region.
...
1. Search or scroll down the left menu to Keyboard 
1. At the "Text Input" (or "Input Sources") section, click "Edit" of Input Sources for a pop-up.
1. Click the "+" button at the lower-left for a pop-up of keyboards.
1. Search for "Chinese, Simplified" at the left and select it.
1. On the right side, choose "Pinyin - Simplified", then click Add to dismisss the pop-up.
1. Click "Done" to dismiss the pop-up menu.
1. Click the red "x" at the upper-left to dismiss the Keyboard pop-up menu.
1. To switch from within any app: in your top menu bar, click the (A) flag icon, click "Pinyin" or
   or press Control + Spacebar.

On iPhone/iPad:

1. Go to Settings > General > Keyboard.
1. Tap Keyboards > Add New Keyboard...
1. Find Simplified Chinese and tap it.
1. Turn off "Show Predictions" if you don't want the English keyboard to try and autocomplete Chinese words (or leave it on, it's personal preference).
1. To switch: Tap the Globe icon on your keyboard.

On Android mobile:

1. Go to Settings > System > Languages & Input > On-screen keyboard.
1. Select your current keyboard (usually Gboard).
1. Tap Languages > Add keyboard.
...
<a target="_blank" href="https://www.youtube.com/watch?v=Hv6WEWS_re8&t=39s">VIDEO</a>: 
<a target="_blank" href="https://en.wikipedia.org/wiki/Pinyin">The Pinyin alphabet</a> 拼音 (Literally: spelled sounds) was created in 1958 (as ISO 7098-1982) to help <strong>pronounciation</strong>, not as a whole language like Japanese Romaji text.
Pinyin enables Chinese to be typed into QWRTY typewriters used throughout the world.

Alternately, the Zhuyin alphabet is used by Taiwan since 2009 (not covered here). There is also <a target="_blank" href="https://en.wikipedia.org/wiki/Help:IPA">IPA</a> used by academics.
...
1. To type an accented vowel, hold down the base vowel letter (a,e,i,o, or u, with or without pressing shift for upper case) until a small menu with accent options appears (e.g., 1: è, 2: é, 3: ê, 4: ë):
   ...
   * Umlaut/Trema (¨): Press Option + U, then type the letter (e.g., ü)
   To type Ü with an umlaut diacritical, type v -- when the consonant is N or L.
   * Cedilla (¸): Press Option + C (this types ç immediately without needing to press C again)
   * *+* Tilde (~): Press Option + N, then type the letter (e.g., ñ)
    
   Alternately, use the Mac Character Viewer for rare symbols by pressing <strong>Control + Command + Spacebar</strong> (or go to Edit > Emoji & Symbols in the top menu bar). In the search box at the top right, type the name of the accent (e.g., "acute" or "umlaut"). Double-click the character you want to insert it into your text.
...
<a id="Pronounciation"></a>

### Pinyin Pronounciation

"Pinyin" which defines how Chinese is pronouced.

Similar to the ABCs being the first 3 letters of the English alphabet,"BoPoMoFo" is the first four letters (b p m f) of the "Romanized" Chinese alphabet. But ignore the "o" because they're pronouced differently.
...
The letter V is only used to spell foreign names.

A syllable contains an initial and a final. 
...
<a target="_blank" href="https://www.youtube.com/watch?v=Hv6WEWS_re8&t=168s">Memonic</a>: BoPoMoFo are "labial initials" because they involve lip (labial) movement. 
   * b B is like the b in "burger".
   * p P is like the purr like a cat.
   * m M is like M in money.
   * f F is like fun as in games.

<a target="_blank" href="https://www.youtube.com/watch?v=Hv6WEWS_re8&t=228s">Memonic</a>: <a target="_blank" href="https://www.youtube.com/watch?v=Hv6WEWS_re8&t=3m50s">Memonic</a> The next four are called "dental" initials are pronouced by touching the tip of your tongue to the back of your teeth.
   * d D is the initial of duck
   * t T is the initial of tough guy
   * n N is the initial of nut
   * l L is the initial of lucky

<a target="_blank" href="https://www.youtube.com/watch?v=Hv6WEWS_re8&t=301s">Memonic</a>: <a target="_blank" href="https://www.youtube.com/watch?v=Hv6WEWS_re8&t=5m2s] Gutteral initials:
   * g G as in guy punch
   * k K as in come (here)
   * h H as in honey

<a target="_blank" href="https://www.youtube.com/watch?v=Hv6WEWS_re8&t=343s">Memonic</a>: <a target="_blank" href="https://www.youtube.com/watch?v=Hv6WEWS_re8&t=[5m36s] Palatal initials:
   * j J as in Genie
   * q Q as in chipping bird
   * t T as in she as in the female bathroom sign

<a target="_blank" href="https://www.youtube.com/watch?v=Hv6WEWS_re8&t=404s">Memonic</a>: <a target="_blank" href="https://www.youtube.com/watch?v=Hv6WEWS_re8&t=[6m45s] Retroflex initials (roll-tongue edge sounds)
   * zh ZH as in drummer 
   * ch CH as in truck
   * sh SH as in mushroom
   * r R as in shussh (to keep quiet)

<a target="_blank" href="https://www.youtube.com/watch?v=Hv6WEWS_re8&t=540s">Memonic</a>: <a target="_blank" href="https://www.youtube.com/watch?v=Hv6WEWS_re8&t=[9m4s] Dental sibilants
   * Z and in zap when a mosquito gets too close to a zapper
   * C as in the z in putz (stupid guy)
   * S as in snake

<a target="_blank" href="https://www.youtube.com/watch?v=Hv6WEWS_re8&t=621s">Memonic</a>: <a target="_blank" href="https://www.youtube.com/watch?v=Hv6WEWS_re8&t=[10m22s] Medials:
   * I/YI as in eee screaming
   * U/WU as in uoh when someone fell
   * U/YU as in e of sweet

<a target="_blank" href="https://www.youtube.com/watch?v=Hv6WEWS_re8&t=738s">Memonic</a>: <a target="_blank" href="https://www.youtube.com/watch?v=Hv6WEWS_re8&t=[12m48s] Finals:
...
REMEMBER: Some Pinyin words have one of 23 initial consonant sounds.

REMEMBER: y and w are at the end of the list because they're used as syallable separators.

REMEMBER: <a target="_blank" href="https://www.youtube.com/watch?v=s663Wghq-u4&t=4m36s">VIDEO</a>:
Each pinyin word has a tone and 24 finals (some with an umlaut above u):<br />
zn-finals-1920x1080.png

<a target="_blank" href="https://www.youtube.com/watch?v=LH3yhKGg3lk">VIDEO</a>:
REMEMBER: 16 Whole-recognition syllables:
zhi, chi, shi, ri, zi, ci, si, 
yi, wu, yu, ye, yue, yuan, yin, yun, ying

Get your free Chinese pronunciation PDF chart at: https://bit.ly/slc-chart 
...
<strong>Tone</strong> is specified by diacritical marks above vowel letters: 

zn-tones.png

(Cantonese has 6 tones)

https://www.youtube.com/watch?v=obeYAqRDL5E&pp=0gcJCTIB7p79v9jh
Learn the 4 Chinese Tones
by Sing and Learn Chinese

https://www.youtube.com/watch?v=ITSGWi8K-Zk&list=PLv3qxksYLwDNokCz0xIMNeMlon5RR7ooU
Learn to Sing Chinese Songs (Lyrics Explained)
by Sing and Learn Chinese

https://www.youtube.com/watch?v=UzZyc2BobYw
sound alike questions

https://www.youtube.com/watch?v=ATtAHQQKBas
...
Write from top left to right, top to bottom.

https://www.youtube.com/watch?v=QSeInNtwvEY&pp=ugUHEgVlbi1VUw%3D%3D
morse code won't work
telegraph by coversion to numbers that took months to learn.

https://www.youtube.com/watch?v=sSKoWfa5Z1I


https://www.youtube.com/watch?v=BLdvTuY7OB8
New HSK 1 Course Workbook Lesson 6 : Exercises with Answers : Complete Practice & Solutions
by Mandarin and Mountains 

https://www.youtube.com/watch?v=Std-ucWlfTk
10:14
Speak Chinese Now: 100 Essential Chinese Sentences for 30 Everyday Situations : Part 2 by Effortless Chinese
...
References:
   ...
   * <a target="_blank" href="https://www.youtube.com/watch?v=Vp5vfnPc5b0&pp=ugUHEgVlbi1HQg%3D%3D">Why the West is running a smear campaign against China</a> by Kishore Mahbubani
   ...
   * <a target="_blank" href="https://www.youtube.com/watch?v=p2F2zfabXto#:~:text=America%20is%20Unlivable-,Know,-way%20no%20how">VIDEO</a>
   * <a target="_blank" href="https://www.youtube.com/watch?v=jC-0KNtkCkE">VIDEO</a>
...
Learn Chinese Now
   ...
   * https://www.youtube.com/watch?v=Pa6UpQFnJVg = Chinese MYTHICAL Animals EXPLAINED... Dragon, 9-Tail fox, Q
   * Shang-Chi and the Legent of the Ten Rings

<a target="_blank" href="https://www.youtube.com/watch?v=3dT8Wm5oI_o&list=PLUl4u3cNGP60g8vnEsLGuA4Kt-d5vNqy9">
Lecture 1, 3, 21, 23: 2024 Introduction to China's History</a> by 
<a target="_blank" href="https://ocw.mit.edu/courses/21h-151-dynastic-china-fall-2024/video_galleries/lecture-videos/">
MIT OpenCourseWare</a> featuring Tristan G. Brown 
- <a target="_blank" href="https://www.youtube.com/watch?v=TgKnFdrda-g&list=PLzX3GuY8oecrs3TA7MTZbnPicD6sMMwHv">Journey to the West 1986 TV series</a> during Song dynasty (monkey king)
...
https://www.netflix.com/watch/81605078?trackId=284616272
Movie: Who Rules the World (40 episodes)

https://www.youtube.com/watch?v=SHBTevu_eTc&pp=ugUHEgVlbi1HQg%3D%3D
39:33
Inside The Forbidden City: Historian Explores Ancient Beijing
History Hit
...
TRIVIA: China shares land borders with 14 countries.
...
* 北美洲 Běiměizhōu North America
   * 加拿大 Jiānádà Canada
   * 美国 Měiguó The United States (gold mines)
* 南美洲 Nánměizhōu South America
   * Bolivia (silver mines)
   * Venusquela (oil. 29-hour flight thru Auckland)
* 欧洲 Ōuzhōu Europe
   * 法国 Făguó France
   * 英国 Yīngguó UK
   * 意大利 Yìdàlì Italy
   ...
   * 俄罗斯 Èluósī Russia
* Middle East
   * Brunei Darussalam (China's airbase)
* 非洲 Fēizhōu Africa
* 南极洲 Nánjízhōu Antarctica

## Century of Humiliation

During the "Century of Humiliation" for China atartin 1839, foreign powers imposed unequal treaties, extracting wealth from China during two "Opium Wars". Hong Kong was ceded to England and Macau to Portugal.
France and other Europeans got a piece of Shanghai. Since 1997 Macau has the highest per-capita income in the world. However, trauma remain in a mindset even in young people:

* In the early 1800s, Britain was buying massive amounts of Chinese tea, silk, and porcelain, but China didn't want British goods. When Britain ran low on silver (from Bolivia) This created a massive trade deficit for Britain (Britain was losing tons of silver to China). To fix this, British merchants (with the backing of the British government) began illegally smuggling opium grown in India into China, which created millions of addicts.
* 1839 – 1842 The First Opium War
* 1842. The Treaty of Nanjing forces China to cede Hong Kong to the British Empire until 1997.

* January 24, 1848. Gold discovered at Sutter's mill in Coloma, 45 miles northeast of Sacramento, California. Chinese Diaspora of 250,000 begins.
* 1850–1864. Taiping Rebellion led by Hong Xiuquan, who believed he was the brother of Jesus Christ, led to an estimated 20 to 30 million deaths.
* 1854. In "People v. Hall", California Supreme Court ruled that Chinese immigrants ("Mongolian") were not allowed to testify in court against a white person. This led to increased violence.
* 1856 – 1860. After losing the Second Opium War, China is forced to legalize the opium trade and cede the Kowloon Peninsula to the British and 400,000 square miles (outer Manchuria), including the Pacific port of Vladivostok. Westerners could build churches anywhere in China.
* May 10, 1869. The photo at Promontory Summit, Utah celebrating the transcontinental railroad completion deliberately excluded the 10,000 to 20,000 Chinese workers (80% to 90% of the Central Pacific Railroad's labor force). Chinese workers were paid significantly less than white workers. Over 1,000 Chinese workers died in avalanches, explosions, and landslides.
* 1871. White workers, facing unemployment and lower wages, begin to violently blame the Chinese. Anti-Chinese riots break out across the West (in Montana and most notably the Los Angeles Chinese Massacre of 1871).
* 1861. "Self-Strengthening Movement" adopted Western technology and military hardware, but did no adopt Western political, economic, or educational systems over China's Confucian culture.
* May 6, 1882. The Chinese Exclusion Act is passed by Congress and signed into law by President Chester A. Arthur. The law was made permanent in 1902.
* 1911. Ching Hi? revolution, then war lords
* 1937. Japanese invade China
* 1945. Japanese bombing of Pearl Harbor begins war with the US
* 1946. Civil War resumes in China. Long March.
* October 1, 1949. Mao proclaims the PRC. US-backed Nationalists flee to Taiwan.
* 1958 "The Great Leap Forward" established collective farms
* October 3, 1965. The US Immigration and Nationality Act (Hart-Celler Act) signed into law by President Lyndon B. Johnson. It dismantles the discriminatory quota of 105 Chinese immigrants per year into the US.
* 1971 PRC replaces Taiwan at the UN
* February 21-28, 1972. Nixon's visit to Mao

* 1989 Tienamen square
* 2001 China enters World Trade Organization
* 2008 Global financial crisis
* 2011. Frank Wolf (R-VA) Amendment (Section 1340 of Public Law 112-10) restricts appropriations for NASA cooperating with China (International Space Station). China's civilian space program (CNSA) is heavily intertwined with the People's Liberation Army (PLA). <a target="_blank" href="https://defense360.csis.org/bad-idea-the-wolf-amendment-limiting-collaboration-with-china-in-space/">Bad idea</a>.
* 2018 Trump launches tariff trade wars
* 2019 COVID lock-down
* 2020 US senator Marco Rubio (Lu Bi Ao) labeled a liberal and banned from China for his criticism of Uyghurs and Hong Kong protesters.
* May 14, 2026. US senator Marco Rubio (Lubio) enters China among Trump's delegation with a different Chinese name.
* 2024 AI chips
* 2026 China "immune" to US-Iran war oil disruption and "saves the world"

Visitors to China:
   * https://www.youtube.com/watch?v=DFibtJGLpxA = Belgium Max 
   * <a target="_blank" href="https://www.youtube.com/watch?v=zvn-lI3PMl8">"I Spent 45 Days in China... Here's What Americans Don't Know"</a>
   * How “Humiliation” Drives China’s Radical Tech Rise</a>
...
Similarly:
   ...
   * <a target="_blank" href="https://www.youtube.com/watch?v=V3Ff1QhXgFg&t=53s&pp=ugUEEgJlbg%3D%3D">5 Patterns That Unlock 75% of Chinese Words</a>
...
* clocks (sounds like sòng zhōng - to attend someone's final moments)
...
https://www.netflix.com/browse/genre/100375
Netflix Chinese-Language Movies & TV

https://www.youtube.com/watch?v=5zYOCMol08o
Top 10 Best Chinese Movies of All Time on Netflix and YouTube : Mind-Blowing Chinese Movies

https://www.youtube.com/watch?v=JpgHdLHqhuw
Top 10 Chinese Movies Every Cinephile Must See – Ranked


Criterion Channel — best for major auteurs and film-history picks, including Jia Zhangke and Hong Kong/Taiwanese cinema. It is available in the U.S.; use its country and director filters to find current titles.

AsianCrush — a focused Asian-film service with Chinese films and dramas, available through web, Roku, Android, and iOS. Its catalog includes titles such as Better Days.

Netflix — browse its dedicated Chinese Movies & TV category; subtitle/audio availability is title-specific, so open a film’s details before starting.

Well Go USA — a leading U.S. distributor for contemporary Chinese and other Asian films. Its Chinese-language catalog points to rental/purchase options such as Apple TV, Google Play, and YouTube.

iQIYI International / Viki / YouTube — often strongest for recent mainland Chinese dramas and some films; look for the “English subtitles” label and confirm your U.S. region before committing.

For more serious cinema, start with Jia Zhangke on Criterion. For modern, accessible drama, try Better Days on AsianCrush. Availability and subtitle tracks rotate, so search the exact title on the service before subscribing or renting.
...
https://www.youtube.com/watch?v=ZfxftB37c5E
22:56
I Investigated Shen Yun's HQ, Here's What I Found...
https://www.shenyun.com USE CODE: LCN2026
New York Times hit pieces
Falun Gong/Dafa
https://www.youtube.com/watch?v=StL8HFFB7Bk

<a target="_blank" href="https://www.youtube.com/watch?v=PuKLaYmFEjk">
14:18</a> China’s 5 Greatest Artworks Explained in One Video
* 00:34 - Terracotta Army
* 02:12 - Admonitions of the Court Instructress 292 AD
* 05:27 - Mogao Caves 366 AD - 1400 AD Buddist along the Silk Road
* 06:53 - The Preface to the Orchid Pavilion Gathering 37 poems Running Script caligraphy by Lantingji Xu 353 AD - Drinking goblets
* 11:00 - The National Museum of China <a target="_blank" href="https://www.dpm.org.cn">Palace Museum</a> <a target="_blank" href="https://digicol.dpm.org.cn/">digitized their greatest treasures</a> in ultra-high & <a target="_blank" href="https://www.youtube.com/@PalaceMuseumBeijing">3D video</a>. "Along the River During the Qingming" (Qingming Shanghe Tu) tomb sweeping Festival from the 12th century Sung Dynasty is China's "Mona Lisa". In complete form of 15 feet is displayed  for a few weeks every few years.

<a target="_blank" href="https://www.youtube.com/watch?v=0pVDYgDSgCQ&pp=ugUEEgJlbg%3D%3D">Top 5 Greatest Paintings in Chinese History</a>

* At the National Museum of China, Beijing <a target="_blank" href="https://www.youtube.com/results?search_query=palace+museum+beijing">VIDEO</a>: the Houmuwu Ding (Simuwu Ding) bronze cauldron from the late Shang Dynasty (c. 1300–1046 BC) weighs 832 kg (1,835 lbs) and features intricate taotie (animal mask) motifs. 

* At Hebei Museum, Shijiazhuang is the Jade Burial Suit of Prince Liu Sheng of the Western Han Dynasty (113 BC) - a full-body suit made of 2,498 pieces of green jade sewn together with gold wire.

* At the Shanghai Museum, "Five Great Kilns" of the Song era created at the peak of minimalist ceramic aesthetics.

* At the Palace Museum (Forbidden City) *and
...
<a target="_blank" href="https://www.youtube.com/watch?v=Gh3cxOYjjQ8">
Describe Yourself in Chinese 自我介绍</a>

https://www.youtube.com/watch?v=fpwviShEmbc
27:59
The Truth about Chinese Fluency by Cheer Up Chinese
...
by Chinese gossip:
   * https://www.youtube.com/@GossipChinese/videos
   * https://www.youtube.com/watch?v=WVuaXU-n07Y I built a Chinese learning escape room game😲
   * https://www.youtube.com/watch?v=OR-obiEEm7E ordering food
...
The BEST Way to Master Chinese Characters (Stop Memorizing!)

https://www.youtube.com/watch?v=IMXN8puYJoY
Master 80% of Daily Chinese in ONE Video!  (HSK 1-2)

https://www.youtube.com/watch?v=WVuaXU-n07Y&pp=0gcJCckLAYcqIYzv
I built a Chinese learning escape room game😲

https://www.youtube.com/watch?v=JLkKnJ8QIGk
Fun History You Must Know Before Learning Chinese

https://www.youtube.com/watch?v=0PxWmJ2Fzss
How to Learn Chinese in a Fun Way

https://www.youtube.com/watch?v=027MgCvbWkg
Learn Chinese Through Animation : Introduce Yourself（HSK1）
https://www.youtube.com/watch?v=Gh3cxOYjjQ8&pp=0gcJCckLAYcqIYzv
Chinese Daily Podcast : Describe Yourself in Chinese : 自我介绍 : Slow Chinese Podcast : HSK1–HSK2
Speak Chinese With Me

https://www.youtube.com/watch?v=fOqtcqib_BA
Learn Chinese Through Animation : Make Weekend Plans (HSK1-2)

https://www.youtube.com/watch?v=9RmY4JNDWaQ
Learn Chinese Through Animation : Shopping & Bargaining (HSK 1,2)

https://www.youtube.com/watch?v=I06FqEflKZE
Learn Chinese Through Animation :  Travel to the Forbidden City(HSK1-2)

https://www.youtube.com/watch?v=vjfcJPjPfeY
make new friends

https://www.youtube.com/watch?v=AyUxomg5Oeo
The Super Common Chinese Number "一": 3 Tones, Which One to Use?
...
https://www.youtube.com/watch?v=_w7sK2GYw54

Preply use 1:1 platform (50% off): http://preply.sjv.io/nXKmex

https://www.youtube.com/watch?v=xQXiSGDXknA
How to Actually Use AI for Language Learning (LLMs The Expert Way)
@languagejones
pushes https://learn.lingopie.com/languagejones using LLM with personalized TV & movie clips

online dictionary to click the speaker icon to hear a native pronunciation:
(e.g., Pleco, <a target="_blank" href="https://translate.google.com/?sl=zh-TW&tl=en&text=车水马龙&op=translate">Translate.Google.com</a>, or YouGlish) 
...
Apps for Daily Progress:

* Language Transfer: https://www.languagetransfer.org/ free

* $20.95/mo. Pimsleur app (7 days free): http://imp.i271380.net/BrianWiles $165/yr conversations. Learn while you drive, run, or garden.
...
* History, Society & Traditions 🏛️
* Education, Learning & Personal Development 📚✨
* Literature & Storytelling 📖📝
* Leisure, Entertainment & Hobbies 🎮🎭
* Identity, Relationships & Emotions 🧠❤️
* Phrases and Conversations 📢🗣️


Language exchange 
Don't use tap-and-match boring
Rosetta stone
Duolingo
Drops 
Jumpspeak
...
https://www.youtube.com/watch?v=mXxYIuUAFkY
How Are Chinese Characters Formed? : 3 Major Types Explained
Everyday Hanzi
...
Janus Academy - Learn Chinese & Japanese

https://www.youtube.com/watch?v=MwwTfcYFhLI
How I learned Mandarin Chinese in 6 months *self-taught at home* 4-6 hrs/day
Dr. Izzy Sealey

https://www.youtube.com/watch?v=c0uMvFqXqVk
7:41
Numbers 0–10 & Days of the Week : Chinese for Beginners
...
* 争先恐后 - zhēngxiānkǒnghòu = Striving to be first and fearing to 
...
* 翻山越岭 - fānshānyuèlǐng = To pass over mountains ridges / fig the hardships of the journey.
* 脱颖而出 - tuōyǐng’érchū = To reveal one’s talent / to rise above others / to distinguish oneself.
* 超凡脱俗 - chāo fántuō sú = To stand out as extraordinary.
* 如火如荼 - rúhuǒrútú = Like wildfire / unstoppable.
* 一举两得 - yī jǔ liǎng dé = One move, two gains / two birds with one stone.
* 迫在眉睫 - pòzàiméijié = lit. Pressing in on one’s eyelashes / fig. Imminent.
* 座无虚席 - zuòwúxūxí = lit. A banquet with no empty seats / full house / capacity crowd / standing room only.
* 愚公移山 - yúgōngyíshān = The old man moves mountains / fig. Where there’s a will, there’s a way.
* 记忆犹新 - jìyìyóuxīn = To remain fresh in one’s memory.
* 世外桃源 - shìwàitáoyuán = Peach Blossom Spring / a hidden land of peace and prosperity / utopia / paradise.
* 应运而生 - yìngyùnérshēng = lit. To emerge to meet a historic destiny / fig. To arise at an opportune time / able to take advantage of an opportunity / to rise to the occasion.
* 活到老，学到老 - huódàolǎo, xuédàolǎo = One is never too old to learn.
* 翻天覆地 - fāntiānfùdì = lit. Sky and the earth turning upside down / fig. Complete confusion / everything turned on its head.
* 大街小巷 - dàjiēxiǎoxiàng = lit. Great streets and small alleys / fig. Everywhere in the city.
* 能歌善舞 - nénggēshànwǔ = lit. Can sing and dance / fig. A person of many talents.
* 天上掉馅饼 - tiānshang diào xiànbǐng = lit. A pie in the sky / fig. A free lunch.
* 天有不测风云 - tiānyǒubùcèfēngyún = lit. A storm may arise from a clear sky / fig. Something unexpected may happen any time.
...
* 灰犀牛 Huī xīniú "grey rhino" is a meme for a danger that's huge, obvious, and charging strait at you. 
   ...
   * https://www.youtube.com/watch?v=EwoF1E8ed5k = slang www.youtube.com/@valerie_chinese

## Fluent Forever

https://www.youtube.com/watch?v=jC-0KNtkCkE

https://www.youtube.com/watch?v=OxfKGlb2pFg
How to Start Writing Chinese Characters (Step by Step)
Grace Mandarin Chinese

Dog breeds from China

Story of China's most beautiful woman: 
https://youtu.be/_GG0meN-OQM

https://www.youtube.com/watch?v=4UYkiXT-lQ0
8:02
...
PROTIP: Unlike European languages, one cannot ask a question by turning the end of sentences into a question using rising intonation. Tone 2

TODO: Use https://www.archchinese.com/mandarin_chinese_tone_drill.html to practice Mandarin tone change rules:

1. When a 3rd tone is followed by another 3rd tone, the first one becomes a 2nd tone. For example, 你好(nǐhǎo => níhǎo).

2. When the character 一(one), which is a 1st tone by itself, is followed by a 1st, 2nd, or 3rd tone, it becomes a 4th tone. For example, 一些(yīxiē => yìxiē).

3. When the character 一(one), which is 1st tone by itself, is followed by a 4th tone, it becomes a 2nd tone. For example, 一半(yībàn => yíbàn).

4. When the character 不(no,not), which is a 4th tone by itself, is followed by another 4th tone, it becomes a 2nd tone. For example, 不要(bùyào => búyào).


https://www.youtube.com/watch?v=ATtAHQQKBas
How to MASTER the Tones of Mandarin Chinese
Learn Chinese Now

https://www.youtube.com/watch?v=xTc_VlEV3yY
t’s Not Just Tones: Chinese ALSO Has Intonation (why robots don't sound natural)
Julesy
...
https://www.youtube.com/watch?v=ikBI9pk84EE
(Pt 2)The SECRET to Perfect Mandarin Tone Pronunciation

https://www.youtube.com/watch?v=4ZY8rzG0x5I
7:45
Are You Pronouncing the Third Tone Correctly?/Tone3 combination/Mandarin pronunciation Basics#4
Chinese with Fang and Bright

https://www.youtube.com/watch?v=_rkKJg9gRK0
10:55
Can’t Hear Chinese Tones? Here’s the Method You’ve Been Missing!
Lala Chinese 啦啦的中文课

https://www.youtube.com/watch?v=tMQQoNbjUas&pp=ugUEEgJlbg%3D%3D
Why Do Chinese Words All Sound the SAME?!
Mandarin Blueprint

https://www.youtube.com/watch?v=OewzOCvDYjg
6:01
...
Brian Wiles
   * https://www.youtube.com/watch?v=WyehfFj72zY&pp=ugUEEgJlbg%3D%3D = 11:49 How to Learn Chinese (Mandarin) On Your Own for FREE

<a target="_blank" href="https://www.youtube.com/@HarbinMandarin">Harbin Mandarin</a>
   * https://www.youtube.com/watch?v=tW3j0TP5N7A = Learn The Chinese Characters 人 大 天 夫 : CC01 : Learn to Read and Write Chinese Characters 

by AhHanzi
   * https://www.youtube.com/watch?v=Fu8F_XJyIkI 8:41 The BEST Way to Master Chinese Characters (Stop Memorizing!) 

by Learn Chinese Now
   * https://www.youtube.com/watch?v=dGBuXn6G0js 11:23 The Forgotten Legend Behind Every Chinese Character
 
by Jared Tells Tales
...
https://www.youtube.com/watch?v=Uf8luHnpVS4
Kung Fu Panda