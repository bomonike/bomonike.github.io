...
layout: post
date: "2026-01-25"
lastchange: "26-01-25 v096 svcs :aws-onboarding.md"
...
1. Verify install:
   ...
   <pre>aws-cli/2.33.2 Python/3.13.11 Darwin/24.6.0 source/arm64</pre>

1.    To prompt acceptance or override of default AWS ACCESS KEY ID, AWS SECRET ACCESS KEY, and region saved as a plain-text file at <pre><strong>~/.aws/credentials</strong></tt>
