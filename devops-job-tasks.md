...
layout: post
date: "2026-07-22"
lastchange: "v014 + skill categories :devops-job-tasks.md"
...
However, <a target="_blank" href="https://wilsonmar.github.io/devops-job-tasks/">this page</a> focuses on the contributions, achievements, and outcomes from working DevOps (DevTestSecOps or DevXOps), based on <strong>Job Task Analysis</strong>.

<a name="MyRadar"></a>

## My DevOps Skills Radar Chart

<a target="_blank" href="https://res.cloudinary.com/dcajqrroq/image/upload/v1753220553/DevOpsSkills_Radar_Chart_hwusmm.png"><img alt="DevOpsSkillsRadarChart.png" src="https://res.cloudinary.com/dcajqrroq/image/upload/v1753220553/DevOpsSkills_Radar_Chart_hwusmm.png" /><em>Click for full screen</em></a>

In <a href="#MyRadar">this sample radar chart</a>:

The <strong>red</strong> line shows the <strong>desired profile</strong> for a Senior DevOps Engineer. Other jobs would have a different red profile line.

The <strong>blue</strong> line showing ratings for (hypothetically) "Your profile" (job).

DO THIS: Print out the above and replace with your rating based on the <a target="_blank" href="#Categories">Categories detailed below</a>.

<strong>Your gap</strong> is the work needed to close the gap.

<a name="MyRadar"></a>

Wherever a both or red lines meets a category line, the further that point is from the center, the more <strong>maturity</strong> is noted (<em>Text generated by Claude</em>):
...
WARNING: Are these ratings <strong>realistic</strong> or too ambitious?
...
In each Category in the <a href="#MyRadar">Radar Chart above</a>, we've endeavored to list all tasks performed within modern computer-using organizations:

A. <strong>Organizational experience</strong> (Etiquette, Events, Presentations, OKRs, Planning, Budgeting, Roles, Permissions, Incident Response, Feedback)<br />
...
G. <strong>Network & system admin.</strong> (IAM, Firewalls, Gateways, Messaging, IoT)<br />
H. <strong>Creativity with AI/ML</strong> (Debugging, GenAI prompting, LLM, Wearables, Robotics)<br />

I. <strong>Operating System control</strong> (OS flavors, Utilities, PATHs, files, folders, runtimes)<br />
...
L. <strong>Data & ML Analytics</strong> (n8n, dashboards, trends, projections, migrations, Machine/Deep Learning, RAG Embedding, LLM workflows, context engineering)<br />

M. <strong>Imperative programming</strong> using Python, C, Go, Rust, Ruby (frameworks, libraries, strings, lists, arrays, vectors, matrices, loops)<br />
...
QUESTION: How do the categories compare & contrast against other frameworks?
   ...
   * <a href="#Microsofts">Microsoft's</a>
   * <a href="#42s">42's</a> adds "Object-Oriented" and "Functional" Programming, which not everyone is devoted to now.
   * <a href="#DASAs">DASA's Areas of Skills and Knowledge</a>
   * <a href="#DevopsInstitute">Devops Institute</a>
...
## DASA's Areas of Skills and Knowledge
