...
layout: post
date: "2025-03-27"
lastchange: "v014 + revised intro :algorithmic-complexity.md"
...
Not shown above are run times for <a href="#Factorial">Factorial</a>, <a href="#Cubic">Cubic</a>, and <a href="#Exponential">exponential</a> algorithms.
...
</td><td> Recalculate once for each N
</td></tr>

<tr valign="top"><td> O(LogN) </td><td> Logarithmic
</td><td> When inputs are divided in segments. No horizontal asymptope, but approaches 32.
</td></tr>
...
</td><td> <a href="#BubbleSort">Bubble sort</a> (each item looks at all other items)
</td></tr>
